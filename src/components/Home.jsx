      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center gap-10 h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            I have 1 year of experience building and developing software.
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 ny-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500"
            >
              Portfolio
